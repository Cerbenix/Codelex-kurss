...
function CalculateBMI(int $heightIn_cm, int $weight)
{
  global $lowBMI, $highBMI;
  $BMI = number_format($weight / $heightIn_cm / $heightIn_cm * 10000, 1);
  if ($BMI < $lowBMI) {
    echo "Your BMI is $BMI, you are underweight.";
  } elseif ($BMI > $highBMI) {
    echo "Your BMI is $BMI, you are overweight.";
  } else {
    echo "Your BMI is $BMI, you're within normal range.";
  }
}
